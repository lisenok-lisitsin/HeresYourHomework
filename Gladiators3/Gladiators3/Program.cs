    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (pass == tpass)
            {
                ...
                if (total1 <= 0)
                {
                    Console.WriteLine($"\nThe first gladiator has fallen with {total1} HP, while the second one is alive with {total2} HP");
                    Console.ReadKey();
                }
                else if (total2 <= 0)
                {
                    Console.WriteLine($"\nThe second gladiator has fallen with {total2} HP, while the first one is alive with {total1} HP");
                    Console.ReadKey();
                }
                else
                {
                    Console.WriteLine("Both gladiators are dead..");
                    Console.ReadKey();
                }
            }
            else
